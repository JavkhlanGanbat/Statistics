...
Одоо манай алдагдлын функц тодорхойлогдсон. Гэхдээ нийт алдааг багасгахын тулд градиент бууруулалт гэж нэрлэгддэг аргыг ашиглана. Энэ тохиолдолд градиент гэдэг нь жингүүдийн аль чиглэлд өөрчлөх үед алдаа нь хамгийн хурдтай өсөж буурахыг илэрхийлдэг вектор. 
...
- Fatakdawala, Mustafa. (2018). *Income Dataset* 
  <https://www.kaggle.com/datasets/mastmustu/income>

- Scikit-learn developers. (2024). *Logistic Regression: scikit-learn documentation*.  
...
- Google Developers. (n.d.). *Logistic regression: Loss and regularization*.  
  <https://developers.google.com/machine-learning/crash-course/logistic-regression/loss-regularization>

- Danushka. (n.d.). *Logistic Regression* (lecture notes).  
